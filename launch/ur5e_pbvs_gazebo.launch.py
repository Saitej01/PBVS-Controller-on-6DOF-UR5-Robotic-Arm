#!/usr/bin/env python3
"""
Complete launch for the user's requested architecture:

  UR robot inside Gazebo world
      + corrected table/objects/camera world
      + Gazebo camera bridge
      + static camera TF
      + RGB-D target detector
      + RViz displays

This launch requires the UR Gazebo simulation package:
  sudo apt install ros-jazzy-ur-simulation-gazebo

If the UR launch arguments differ on your local installation, check:
  ros2 launch ur_simulation_gazebo ur_sim_control.launch.py --show-args
"""
...
def generate_launch_description():
    ...
    start_ur_gazebo = LaunchConfiguration('start_ur_gazebo')
    ...
    ur_gazebo_launch = PathJoinSubstitution([
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('start_ur_gazebo', default_value='true'),
        ...
        # This starts the robot INSIDE the same Gazebo world.
        # The important part is world:=pick_and_place_pbvs.world.
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(ur_gazebo_launch),
            launch_arguments={
                'ur_type': ur_type,
                'world': world_file,
            }.items(),
            condition=IfCondition(start_ur_gazebo),
        ),
        ...
        Node(
            ...
            arguments=[
                ...
                '--x', '1.00', '--y', '-1.05', '--z', '1.50',
                '--look_at', '--look_x', '1.00', '--look_y', '0.00', '--look_z', '0.83',
            ],
            output='screen',
